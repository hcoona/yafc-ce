...
goodsHaveNoProduction:;
        ...
        private void ExportIo(float multiplier) {
            ...
            _ = SDL.SDL_SetClipboardText(BlueprintUtilities.ExportConstantCombinators(
                view.projectPage!.name,
                goods,
                format: InputSystem.Instance.control ? BlueprintFormat.RawJson : BlueprintFormat.CompressedBase64)); // null-forgiving: An active view always has an active page.
        }
    }
